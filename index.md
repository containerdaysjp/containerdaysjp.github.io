...
# 公開サービス停止のお知らせ（2018.12.17）

JKDv18.12に向けて開発を進めてきた「showKs」イベント終了後も自由にお試しいただける環境を提供してきましたが、2018年12月17日をもってサービスの公開をいったん停止しました。100を超えるユーザーの皆さんにクラウドネイティブな開発を体験していただくことができました。開発の裏話はJKDでのセッション資料「[showKs開発の舞台裏](https://speakerdeck.com/jacopen/showkskai-fa-falsewu-tai-li)」として公開しています。
